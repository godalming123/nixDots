...
alias repi='killall -q picom && picom --experimental-backends'
alias pi='picom --experimental-backends'
alias screens='bash /usr/share/screenlayouts/primary.sh'
alias conky='bash ~/.config/conky/conkystartup.sh'
alias jgmenu='killall jgmenu'

# configuration aliases
alias config='cd ~/.config && micro /etc/lightdm/lightdm.conf /etc/lightdm/lightdm-gtk-greeter.conf ~/.bashrc ~/.welcome_screen ~/.profile alacritty/alacritty.yml bspwm/bspwmrc picom/picom.conf  polybar/config polybar/launch.sh polybar/polywins.sh sxhkd/sxhkdrc jgmenu/jgmenurc jgmenu/append.csv jgmenu/prepend.csv jgmenu/menu-on-right jgmenu/right-click-menu'

# =========================================
# === If runing as root do nothing more ===
# =========================================
...
# ====================================================
# === Some generally useful functions. And aliases ===
# ====================================================
